...
\caption{Diagram of the ECAL\cite{1748-0221-3-08-S0800}.}
\label{fig:cmsecal}
\end{figure}
...
\begin{figure}[here]
\includegraphics[width=0.9\textwidth]{drif_tube.png}
\caption{Schematic of a DT\cite{1748-0221-3-08-S0800}.}
...
\caption{Schematic of a CSC (left) and an example of a CSC detecting and precisely determining the position of a muon (right).\cite{1748-0221-3-08-S0800}.}
\label{fig:muoncsc}
\end{figure}
