...
\subsection{Elementary Forces: This will include a description of the W Boson}
\subsection{The Higgs Boson}
\section{Beyond the Standard Model: Mention BSM theories that predict an LFV Higgs, mention why we know that there must be new physics beyond the Standard Model, motivate LFV Higgs}


\chapter{LHC Phenomenology}
...
\subsection{Monte Carlo Generators: Overview of different monte carlo generators}
...
\chapter{Analysis Methods: Summarize W+Jets and LFV Higgs ANs}
